  ...
  function (Component, Button, Label, VerticalList, Carousel, DataSource, SimpleFormatter, SimpleFeed) {
    ...
    return Component.extend({
      init: function init () {
        ...
        helloWorldLabel2 = new Label("helloWorldLabel2", "Hello World2");
        this.appendChildWidget(helloWorldLabel2);
        ...
        var hwButton = new Button();
        hwButton.appendChildWidget(new Label("Hello world Button"));
        hwButton.addEventListener("select", function(evt) {
          self.getCurrentApplication().pushComponent("maincontainer", "sampleapp/appui/components/helloworld");
        });
        ...
        verticalListMenu.appendChildWidget(hwButton);
